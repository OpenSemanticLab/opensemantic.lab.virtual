...
Welcome to `opensemantic.lab.virtual` contributor's guide.
...
If you experience bugs or general issues with `opensemantic.lab.virtual`, please have a look
...
You can help improve `opensemantic.lab.virtual` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opensemantic.lab.virtual` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opensemantic.lab.virtual`'s files. While this mechanism can
...
```
conda create -n opensemantic.lab.virtual python=3 six virtualenv pytest pytest-cov
conda activate opensemantic.lab.virtual
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opensemantic.lab.virtual.git
   cd opensemantic.lab.virtual
   ```
...
5. Install [pre-commit]:
   ...
   `opensemantic.lab.virtual` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opensemantic.lab.virtual
[issue tracker]: https://github.com/<USERNAME>/opensemantic.lab.virtual/issues
